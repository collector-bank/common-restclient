...
namespace Collector.Common.RestClient.Interfaces
{
    ...
    public interface IRestApiClient
    {
        ...
        Task CallAsync<TResourceIdentifier>(RequestBase<TResourceIdentifier> request) where TResourceIdentifier : ResourceIdentifier;
        ...
        /// <exception cref="ValidationException">Thrown if request is invalid.</exception>
        /// <exception cref="RestApiException">Thrown if response is not OK or contains RestError.</exception>
        Task<TResponse> CallAsync<TResourceIdentifier, TResponse>(RequestBase<TResourceIdentifier, TResponse> request) where TResourceIdentifier : ResourceIdentifier;
    }
}